...
public class NewsFeedInfoActivity extends ListActivityBase {
	private static final String TAG = "NewsFeedInfoActivity";
    ...
    protected void reloadRemoteData () {
        ...
        o.execAsyncMethod("dolphin.getUserInfoExtra", aParams, new Connector.Callback() {
			...
			public void callFinished(Object result) {
				...
				NewsFeedInfoAdapter adapter = new NewsFeedInfoAdapter (m_actThis, aInfoBlocks, m_sUsername);
